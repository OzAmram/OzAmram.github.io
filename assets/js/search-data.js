    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-dijet-resonance-anomaly-search",
          title: 'Dijet Resonance Anomaly Search',
          description: "The first application of anomaly detection in CMS",
          section: "Projects",handler: () => {
              window.location.href = "/projects/CASE.html";
            },},{id: "projects-cms-pixel-detector",
          title: 'CMS Pixel Detector',
          description: "Calibration and Reconstruction",
          section: "Projects",handler: () => {
              window.location.href = "/projects/CMS_pixel_detector.html";
            },},{id: "projects-calodiffusion",
          title: 'CaloDiffusion',
          description: "Diffusion models for LHC calorimeter simulations",
          section: "Projects",handler: () => {
              window.location.href = "/projects/CaloDiffusion.html";
            },},{id: "projects-parity-violation",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6F%7A.%61%6D%72%61%6D@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-inspire',
        title: 'Inspire HEP',
        section: 'Socials',
        handler: () => {
          window.open("https://inspirehep.net/authors/1635150", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/OzAmram", "_blank");
        },
      },{
        id: 'social-bluesky',
        title: 'Bluesky',
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/ozamram.bsky.social", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/OzAmram", "_blank");
        },
      },{
      id: 'light-theme',
